...
svm-scale -l 0 -u 1 temp/nac_pos_svm.txt > temp/nac_pos_svm_scaled.txt
svm-scale -l 0 -u 1 temp/nac_neg_svm.txt > temp/nac_neg_svm_scaled.txt
...
# python train.py temp/nac_pos_svm_scaled.txt temp/nac_neg_svm_scaled.txt -m dna.model -c 1 9 2 -g -3 1 2 -v 10
